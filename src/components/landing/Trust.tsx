                    ...
                    >
                        ...
                        <div className="flex gap-3.5 flex-wrap">
                            <a
                                ...
                                className="relative flex items-center text-[0.92rem] font-bold rounded-full h-12 p-1 ps-6 pe-14 bg-primary text-white group transition-all duration-500 hover:ps-14 hover:pe-6 overflow-hidden cursor-pointer shadow-[0_4px_20px_rgba(59,130,246,0.4)] active:scale-[0.97]"
                            >
